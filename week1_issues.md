## Group 1 – Authentication & User Access
...
### **Issue 2 – [Frontend] Authentication & Login UI**
**Goal:**  
...
## Group 2 – Volunteer Applications & Admin Dashboard

### **Issue 4 – [Backend] Volunteer Application API**
**Goal:**  
...
### **Issue 5 – [Frontend] Admin Dashboard Shell + Volunteer Application Review UI**
**Goal:**  
...
## Group 3 – Collection Catalogue (Public Side)

### **Issue 6 – [Backend] Public Catalogue API**
**Goal:**  
...
### **Issue 7 – [Frontend] Public Catalogue UI**
**Goal:**  
...
## Group 4 – Item Movement & History Logic

### **Issue 8 – [Backend] Define Item History & Location Rules**
**Goal:**  
...
### **Issue 9 – [Backend] Implement Item History Service**
**Goal:**  
...
### **Issue 10 – [Backend] Move Request & Approval API**
**Goal:**  
